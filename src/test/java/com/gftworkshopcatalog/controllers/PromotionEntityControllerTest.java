...
public class PromotionEntityControllerTest {
    ...
    void getPromotionById_Success() throws Exception {
        ...
        when(promotionService.findPromotiontById(promotion.getPromotionId())).thenReturn(promotion);
        ...
        verify(promotionService).findPromotiontById(promotion.getPromotionId());
    }
    @Test
