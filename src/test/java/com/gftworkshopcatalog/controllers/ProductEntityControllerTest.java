...
class ProductEntityControllerTest {
    ...
    void test_updateProduct_InternalServerError() {
        long productId = 1L;
        ProductEntity updatedProductInput = new ProductEntity(1L, "Jacket","Something indicate large central measure watch provide.", 58.79, 1, 3.71, 26, 10);
        ProductEntity updatedProductResult = new ProductEntity(1L, "Jacket","Something indicate large central measure watch provide.", 58.79, 1, 3.71, 26, 10);

        when(productServiceImpl.updateProduct(productId, updatedProductInput)).thenThrow(new ServiceException("Internal Server Error"));
